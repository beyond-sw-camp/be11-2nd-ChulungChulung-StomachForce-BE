...
🎵 **임성재**  
  ...
  - **배운 점**
    - 프로젝트를 진행할 때 다른 팀원이 맡은 부분이다 하더라도 진행속도가 느리다면 역할 분담을 다시 해서 진행을 해야한다는 것을 배웠습니다.
    - 단순 CRUD를 짜더라도 다른 팀원이 맡은 부분을 고려해서 코드를 만들었는데 생각보다 더 디테일한 부분들을 신경 써야한다는것을 깨달았습니다.

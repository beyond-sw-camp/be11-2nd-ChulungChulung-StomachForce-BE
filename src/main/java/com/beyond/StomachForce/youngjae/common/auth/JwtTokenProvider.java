...
public class JwtTokenProvider {
    ...
    public String createToken(String registrationNumber, String role) {
    ...
    public String createRefreshToken(String registrationNumber, String role){
        Claims claims = Jwts.claims().setSubject(registrationNumber);
        claims.put("role", role);
        Date now = new Date();

...
import com.beyond.StomachForce.youngjae.common.auth.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(a->a.requestMatchers("/restaurant/create","restaurant/doLogin","restaurant/refresh-token", "restaurant/list").permitAll().anyRequest().authenticated())
                .build();
    }
